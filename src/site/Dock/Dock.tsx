...
// base-library Footer container. The Footer provides the fixed/animated shell +
// bottom scrim + lightbox retreat; this file owns everything subject-specific:
// the cross-promo project tiles, the "feed the cat" donate action + modal, and
// the invite bubble. None of this belongs in the reusable library.
...
interface Project {
  ...
  icon: string
  href: string
  // Optional shrink for full-bleed logos/photos that lack their own inner
  // padding, so they sit with the same breathing room as the padded icons.
  iconScale?: number
